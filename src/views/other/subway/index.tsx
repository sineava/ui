...
export default () => {
  ...
  useEffect(() => {
    ...
    const data = {
      nodes: [...lineRong.nodes, ...line1.nodes, ...line2.nodes, ...line3.nodes, ...line4.nodes, ...line5.nodes, ...line6.nodes, ...line7.nodes, ...line8.nodes],
      edges: [...lineRong.edges, ...line1.edges, ...line2.edges, ...line3.edges, ...line4.edges, ...line5.edges, ...line6.edges, ...line7.edges, ...line8.edges, ...walk.edges]
    }
    graph.data(data)
    graph.render()
  }, [])
